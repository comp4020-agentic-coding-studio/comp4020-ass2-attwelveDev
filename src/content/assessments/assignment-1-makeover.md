---
title: "Assignment 1: Makeover"
description:
  A hygiene-product selection and three outfits for three named occasions,
  each attached with evidence and a justification
week: 4
...
marking:
  mode: weighted
  criteria:
    - name: Hygiene product selection
      weight: 40
    - name: Outfit appropriateness
      weight: 40
    - name: Justification
      weight: 20
spec:
