...
A sleep schedule and an exercise routine are both maintenance windows: time
set aside so the rest of the system keeps running. Skipping a maintenance
window rarely fails immediately — it fails later, somewhere else.
